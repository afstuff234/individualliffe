<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_GP_PROP_POLICY.aspx.vb" Inherits="G_LIFE_PRG_GP_PROP_POLICY" %>
...
<body style="background-color: White;">
    ...
    <div id="div_header" align="center">
            <asp:Panel ID="menuPanel" CssClass="menuPanel" runat="server">&nbsp;&nbsp;
                &nbsp;<asp:LinkButton ID="LNK_QUOTE" Enabled="true" runat="server" Text="Quotation Entry" PostBackUrl="PRG_GP_PROP_POLICY.aspx?menu=GL_QUOTE"></asp:LinkButton>&nbsp;
                &nbsp;<asp:LinkButton ID="LNK_DOC" Enabled="true" runat="server" Text="Quotation Document" PostBackUrl="PRG_GP_PROP_POLICY.aspx?menu=GL_DOCUMENT"></asp:LinkButton>&nbsp;
                &nbsp;<a class="HREF_MENU2" href="#" onclick="javascript:JSDO_RETURN('../M_MENU.aspx?menu=HOME')">Return to Main Menu</a>&nbsp;
        </asp:Panel>
