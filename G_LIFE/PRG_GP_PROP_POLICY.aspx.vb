...
Partial Class G_LIFE_PRG_GP_PROP_POLICY
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        STRMENU_TITLE = "+++ Group Life Proposal Menu +++ "
        BufferStr = ""
    ...
    Private Sub DoProc_Menu(ByVal pvMenu As String)
        Select Case pvMenu.ToUpper
            ...
            Case "GL_QUOTE"
                ...
                AddMenuItem("Quotation Entry", "New Quotation", "PRG_LI_GRP_POLY_PERSNAL.aspx?optid=NEW")
            ...
            Case "GL_DOCUMENT"
                STRMENU_TITLE = "+++ Quotation Document Menu +++ "
                AddMenuItem("", "Returns to Previous Page", "menu_gl.aspx?menu=home")
                AddMenuItem("", "UNDER_LINE", "") 'blank link
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("Quotation Document", "GROUP LIFE ASSURANCE", "PD_GL001.aspx?opt=G001")
                AddMenuItem("", "GROUP FUNERAL", "")
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("", "GROUP CREDIT LIFE", "")
                AddMenuItem("", "GROUP MORTGAGE", "")
                AddMenuItem("", "GROUP WELFARE SCHEME", "")
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("", "GROUP TUITION", "")
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("", "GROUP CRITICAL ILLNESS", "")
                AddMenuItem("", "FUND MANAGEMENT SCHEME", "")
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("", "UNDER_LINE", "") 'blank link
                AddMenuItem("", "Returns to Previous Page", "menu_gl.aspx?menu=home")
