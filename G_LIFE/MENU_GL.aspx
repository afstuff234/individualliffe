<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MENU_GL.aspx.vb" Inherits="G_LIFE_MENU_GL" %>
...
<body>
    ...
    <div id="div_header" align="center">
        <asp:Panel ID="menuPanel" CssClass="menuPanel" runat="server">&nbsp;&nbsp;
            ...
            <asp:LinkButton ID="LNK_QUOTE" Enabled="true" runat="server" Text="Quotations" PostBackUrl="PRG_GP_PROP_POLICY.aspx?menu=GL_QUOTE"></asp:LinkButton>&nbsp;
