<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_INDV_POLY_MEDIC_ILLNESS.aspx.vb"
    Inherits="I_LIFE_PRG_LI_INDV_POLY_MEDIC_ILLNESS" %>
            ...
            <tr>
                <td align="center" valign="top" class="td_menu">
                    <table align="center" border="0" class="tbl_menu_new">
                        ...
                        <tr>
                            <td nowrap align="left" valign="top">
                                <asp:Label ID="lblQuote_Num" Enabled="false" Width="250px" Text="Proposal No:" runat="server"></asp:Label>
                            </td>
                            <td align="left" valign="top" colspan="1">
                                ...
                                <table align="center" border="1">
                                    <tr class="tr_frame">
                                        <td align="left" valign="top">
                                            <asp:Label ID="lblMed_Illness_Date" Text="Illness Date" runat="server"></asp:Label>
                                            <br />
                                            <asp:Label ID="lblMed_Illness_Date_Format" Text="dd/mm/yyyy" runat="server"></asp:Label>
                                        </td>
                                        <td nowrap align="left" valign="top">
                                            <asp:Label ID="lblMed_Illness_Code" Text="Illness Type" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="font-size: small;">
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtMed_Illness_Date" MaxLength="10" runat="server"></asp:TextBox>
                                        </td>
                                        <td align="left" valign="top">
                                            <asp:DropDownList ID="cboMed_Illness_Code" Width="300px" runat="server">
                                            </asp:DropDownList>
                                            &nbsp;<asp:TextBox ID="txtMed_Illness_Code" Visible="false" Enabled="false" MaxLength="10"
                                                Width="40px" runat="server"></asp:TextBox>
                                            &nbsp;<asp:TextBox ID="txtMed_Illness_Name" Visible="false" Enabled="false" Width="40px"
                        ...
                        <tr>
                            <td align="center" colspan="4" valign="top">
                                <table align="center" style="background-color: White; width: 95%;">
                                    <tr>
                                        <td align="left" colspan="4" valign="top">
                                            <asp:GridView ID="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl" DataKeyNames="TBIL_POL_ILL_REC_ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField ReadOnly="true" DataField="TBIL_POL_ILL_REC_ID" HeaderText="Ref.No"
                                                        HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
                                                    <asp:BoundField ReadOnly="true" DataField="TBIL_POL_ILL_FILE_NO" HeaderText="File No"
                                                        HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
                                                    <asp:BoundField ReadOnly="true" DataField="TBIL_POL_ILLNESS_DATE" HeaderText="Illness Date"
                                                        HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" DataFormatString="{0:dd MMM yyyy}" />
                                                    <asp:BoundField ReadOnly="true" DataField="TBIL_POL_ILLNESS_NAME" HeaderText="Illness Type"
                                                        HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
                                                </Columns>
                                            </asp:GridView>
                                        </td>
