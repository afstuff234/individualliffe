<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_POL_RENEWAL_RECEIPT.aspx.vb" Inherits="PRG_LI_POL_RENEWAL_RECEIPT" %>
        ...
        $(document).ready(function() {
            ...
            function retrieve_LoadPeriodsCover(coverdets) {
                ...
                $.each(coverdets, function() {
                    ...
                    document.getElementById('txtTransDesc2H').value = $(this).find("sPeriodsCoverRange").text()
                });
            }
                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="right" colspan="2" valign="top">    
    	                        ...
    	                        &nbsp;&nbsp;<asp:DropDownList ID="cboSearch" runat="server" Height="26px" AutoPostBack="true"
                                    ...
                                    <tr>
                                        <td align="center" colspan="4" valign="top">
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="cmdPrev" CssClass="cmd_butt" Enabled="false" 
                                                Text="«..Previous" runat="server" Visible="False" />
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="cmdNext" CssClass="cmd_butt" Enabled="false" 
                                                Text="Next..»" runat="server" Visible="False" />
                                            &nbsp;&nbsp;
                                        </td>
                                    </tr>
                    ...
                    <td align="center" valign="top" class="td_menu">
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtFileNo" Width="250px" 
                                                        runat="server"></asp:TextBox>
                                                    &nbsp;&nbsp;<asp:Button ID="cmdFileNum" Text="Get Record" runat="server" /></td>
                                                <td align="left" valign="top"><asp:Label ID="lblPolNum" Text="Policy Number:" Enabled="true" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtPolicyNo" 
                                                        Width="250px" runat="server"></asp:TextBox><asp:Button ID="cmdGetPol" Enabled="false" Text="Go" runat="server" /></td>
                            </tr>
...
<tr>
                                ...
                                <td align="left" valign="top">                                     <asp:TextBox ID="txtProduct" runat="server" Enabled="false" Width="36px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td align="left" colspan="4" valign="top" class="myMenu_Title">Payment instrument Information</td>
                                    </tr>

<tr>
                                                <td align="left" valign="top"><asp:Label ID="lblDOB" Text="Batch No:" 
                                                ...
                                                <asp:ListItem Value="NB" Text="New Business"></asp:ListItem>
                                                <asp:ListItem Value="RN" Text="Renewal Premium" Selected=True ></asp:ListItem>
                                            </asp:DropDownList>
                                                </td>
                                    </tr>
                            <tr>
                                                <td align="left" valign="top"><asp:Label ID="lbleffDate" Enabled="true" Text="Instrument Date:" runat="server"></asp:Label></td>
                                            ...
                                            <asp:DropDownList ID="cmbReceiptType" runat="server" Width="126px" Enabled=false >
                                                <asp:ListItem Value="0" Text="Receipt Type"></asp:ListItem >
                                                <asp:ListItem Value="D" Text="D-Premium Deposit"></asp:ListItem>
                                                <asp:ListItem Value="P" Text="P-Regular Premium" Selected =True ></asp:ListItem>
                            ...
                            <tr>
                                <td nowrap align="left" valign="top"><asp:Label ID="lblTellerNo" Text="Instrument No:" runat="server"></asp:Label></td>
                                <td align="left" valign="top" colspan="1">
                            ...
                            <tr>
                                <td align="left" colspan="4" valign="top" class="myMenu_Title">receipt/Premium Information</td>
                            </tr>
 ...
 <asp:TextBox ID="txtReceiptAmtLC" runat="server" Width="150px" Text="0.00" AutoPostBack="True"></asp:TextBox><%--<asp:RegularExpressionValidator
                            ...
                            <tr>
                                <td align="left" valign="top"><asp:Label ID="lblMainAcctDebit" ToolTip="Account to Debit" Text="Main Account(Debit):" runat="server" CssClass=popupOffset></asp:Label></td>
                                <td align="left" valign="top"> <asp:TextBox ID="txtMainAcctDebit" runat="server"  CssClass=popupOffset
                                        Width="150px" Enabled="False">1020020730</asp:TextBox>
                                            &nbsp;</td>
                                </td>
                                <td align="left" valign="top"><asp:Label ID="lblSubAcctDebit" ToolTip="Sub Account Debit" Text="Sub Account(Debit):" runat="server" CssClass=popupOffset></asp:Label></td>
                                <td align="left" valign="top">                                      
                                    <asp:TextBox ID="txtSubAcctDebit" runat="server" Width="150px" CssClass=popupOffset Enabled="False">000000 </asp:TextBox> 
                                            &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><asp:Button ID="butSave" runat="server" Text="Save" OnClick="cmdSave_ASP_Click" />
                                        ...
                                        <asp:Button ID="butClose" runat="server" Text="Close" Visible="True" /><asp:TextBox ID="txtSubAcctDebitDesc" runat="server" Width="300px" BorderStyle="None" CssClass=popupOffset></asp:TextBox>
                                              ...
                                              <asp:HiddenField ID="txtTransDesc2H" runat="server" />
