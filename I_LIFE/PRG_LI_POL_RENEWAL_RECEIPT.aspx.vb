...
Partial Class PRG_LI_POL_RENEWAL_RECEIPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        STRMENU_TITLE = "Receipts Entry Screen"
        ...
        If Not Page.IsPostBack Then
            ...
            cmbCurrencyType.SelectedValue = "0001"
        ...
        cmbCurrencyType.SelectedValue = "0001"
        cmbCurrencyType.Enabled = False
        cmbReceiptType.SelectedValue = "P"
            ...
            If Me.IsValid Then
                ...
                If Not updateFlag Then 'if new record
                    ...
                    With Rceipt
                        ...
                        Rceipt.TranDescription1 = txtTransDesc1.Text
                        Rceipt.TranDescription2 = txtTransDesc2H.Value
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtFileNo.Text = RTrim(CType(objOLEDR("TBIL_POLY_FILE_NO") & vbNullString, String))
            ...
            Me.txtPolicyNo.Text = RTrim(CType(objOLEDR("TBIL_POLY_POLICY_NO") & vbNullString, String))

            'If IsDate(objOLEDR("TBIL_POLY_PRPSAL_ISSUE_DATE")) Then
            '    Me.txtTrans.Text = Format(CType(objOLEDR("TBIL_POLY_PRPSAL_ISSUE_DATE"), DateTime), "dd/MM/yyyy")
            'End If
            ...
            Me.txtProduct.Text = RTrim(CType(objOLEDR("TBIL_POLY_PRDCT_CD") & vbNullString, String))
            ...
            Me.txtAgentCode.Text = RTrim(CType(objOLEDR("TBIL_POLY_AGCY_CODE") & vbNullString, String))
            Me.txtAgentName.Text = RTrim(CType(objOLEDR("TBIL_AGCY_AGENT_NAME") & vbNullString, String))

            Me.txtInsuredCode.Text = RTrim(CType(objOLEDR("TBIL_POLY_ASSRD_CD") & vbNullString, String))
...
Public Shared Function PaymentsPeriodCover(ByVal _polnum As String, ByVal _mop As String, ByVal _effdate As String, ByVal _contrib As String, ByVal _amtpaid As String) As String
                ...
                Else
                    ...
                    If dt.Tables(0).Rows().Count <> 0 Then
                        If Not IsDBNull(dt.Tables(0).Rows(0).Item("sPeriodsCoverRange")) Then _
                                                     txtTransDesc2H.Value = dt.Tables(0).Rows(0).Item("sPeriodsCoverRange")
                        txtTransDesc2.Text = txtTransDesc2H.Value
                    Else
    ...
    Protected Sub txtReceiptNo_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtReceiptNo.TextChanged
        ...
        fillValues()
    End Sub
    Private Function Local_Proc_DoOpenRecord() As String
    ...
    Protected Sub cmdFileNum_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdFileNum.Click
        If LTrim(RTrim(Me.txtFileNo.Text)) <> "" Then
    ...
    Protected Sub cmdGetPol_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGetPol.Click
        If Trim(Me.txtPolicyNo.Text) <> "" Then
            strStatus = Proc_DoOpenRecord(RTrim("POL"), Me.txtPolicyNo.Text, RTrim("0"))
        End If
    ...
    Protected Sub cboSearch_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboSearch.SelectedIndexChanged
        Try
            ...
            Me.cboSearch.SelectedItem.Value = "" Or Me.cboSearch.SelectedItem.Value = "*" Then
                ...
                'Me.txtSearch.Value = ""
            Else
                Me.txtFileNo.Text = Me.cboSearch.SelectedItem.Value
                strStatus = Proc_DoOpenRecord(RTrim("FIL"), Me.txtFileNo.Text, RTrim("0"))
                Local_Proc_DoOpenRecord()
            End If
        Catch ex As Exception
