<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_POLICY_RECEIPT.aspx.vb" Inherits="I_LIFE_PRG_LI_POLICY_RECEIPT" %>
                    ...
                    <td align="center" valign="top" class="td_menu">
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtFileNo" Enabled="false" Width="200px" runat="server"></asp:TextBox>
                                                    &nbsp;&nbsp;</td>
                                                <td align="left" valign="top"><asp:Label ID="lblPolNum" Text="Policy Number:" Enabled="true" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtReceiptRefNo" Enabled="false" Width="250px" runat="server"></asp:TextBox></td>
                            </tr>
...
<tr>
                            ...
                            <tr>
                                                <td align="left" valign="top"><asp:Label ID="lblTempRectNo" Text="Temp Recpt No:" runat="server"></asp:Label></td>
                                                <td align="left" colspan="1" valign="top"><asp:TextBox ID="txtTempReceiptNo" runat="server" Width="150px"></asp:TextBox>
                                                </td>
                                                <td nowrap align="left" valign="top"><asp:Label ID="lbleffDate" Enabled="true" Text="Effective Date:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1">                                                    
                            ...
                            <tr>
                                                <td align="left" valign="top"><asp:Label ID="lblRcpt_Mode" Text="Receipt Mode:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top"><asp:TextBox ID="txtMode" runat="server" Width="26px"></asp:TextBox>
                                            <asp:DropDownList ID="cmbMode" runat="server" Width="120px">
                                                ...
                                                <asp:ListItem Value="T" Text="T-Teller"></asp:ListItem>
                                                    ...
                                                    &nbsp;</td>
                                                <td align="left" valign="top"><asp:Label ID="lblRcpt_Type" Enabled="true" Text="Receipt Type:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top">  <asp:TextBox ID="txtReceiptCode" runat="server" Width="18px"></asp:TextBox>
                            ...
                            <tr>
                                <td align="left" valign="top"><asp:Label ID="lblCheqNumbee" Text="Cheque No:" runat="server"></asp:Label></td>
                                <td align="left" valign="top" colspan="1">
                                    <asp:TextBox ID="txtChequeNo" runat="server" Width="150px"></asp:TextBox>
                                   
                                </td>
                                <td align="left" valign="top"><asp:Label ID="lblChequeDate" Text="Cheque Date:" runat="server"></asp:Label></td>
                                <td align="left" valign="top"><asp:TextBox ID="txtChequeDate" runat="server" Width="150px"></asp:TextBox>
                                    &nbsp;</td>
                            </tr>
 ...
 <asp:TextBox ID="txtReceiptAmtLC" runat="server" Width="150px" Text="0.00" AutoPostBack="True"></asp:TextBox><%--<asp:RegularExpressionValidator
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="2"><asp:Label ID="lblBranch" Enabled="false" Text="Branch:" runat="server"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><asp:TextBox ID="txtSerialNo" runat="server" Width="150px" Enabled="false"></asp:TextBox>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><asp:Label ID="Label8" Enabled="false" Text="Sub A/C Desc:" runat="server"></asp:Label></td>
                                <td align="left" valign="top"><asp:TextBox ID="txtSubAcctDebitDesc" runat="server" Width="300px" BorderStyle="None"></asp:TextBox>
